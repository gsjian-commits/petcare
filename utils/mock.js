...
const reviews = [
  {
    ...
    rating: 5,
    date: '2026-05-10',
    content: '出差三天找了宠管家上门喂养，管家每天准时到，喂食铲猫砂还陪玩，每天发照片反馈，真的太安心了！猫咪状态也很好，强烈推荐！',
    images: [],
    tags: ['准时', '细心', '猫咪友好']
  },
  {
    ...
    rating: 5,
    date: '2026-05-08',
    content: '已经是第三次用宠管家了，管家小姐姐特别温柔，我家布偶胆子小也愿意跟她互动。每次都把猫砂盆洗得干干净净，比我自己弄的还仔细。',
    images: [],
    tags: ['服务细致', '专业', '值得信赖']
  },
  {
  ...
  },
  {
    ...
    rating: 5,
    date: '2026-05-06',
    content: '出去旅游了五天，猫咪寄养选了宠管家。每天早晚两次上门，管家发来的照片里猫咪状态都很好。回来发现猫咪比我在家时还粘人了哈哈。',
    images: [],
    tags: ['放心', '猫咪状态好', '反馈及时']
  }
];
